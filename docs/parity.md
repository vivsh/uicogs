...
| Routes and Vue binding        | Superseded | Core owns immutable access-aware route definitions; the app owns Vue Router and `withVue()` adds guards.          | [route tests](../packages/vue/src/routes.test.ts)                    |
