...
| Routes and Vue binding        | Superseded | Core owns immutable access-aware route definitions; `withVue()` creates Vue Router and adds guards.               | [route tests](../packages/vue/src/routes.test.ts)                    |
