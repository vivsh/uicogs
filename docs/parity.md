...
| Vue Router                    | Superseded | An optional adapter controls resource-view routes without placing routing in core.                                | [router tests](../packages/vue-router/src/index.test.ts)             |
