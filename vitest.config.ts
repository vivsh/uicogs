...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@uicogs/echarts": fileURLToPath(new URL("./packages/echarts/src/index.ts", import.meta.url)),
      "@uicogs/routes": fileURLToPath(new URL("./packages/routes/src/index.ts", import.meta.url)),
  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        "packages/echarts/src/**": { lines: 90, statements: 90, functions: 90, branches: 85 },
        ...
        "packages/routes/src/**": { lines: 90, statements: 90, functions: 90, branches: 85 },
