...
Supported runtimes are current Chromium, Firefox and WebKit, plus maintained Node.js 22 and 24 releases. Framework packages support the peer dependency ranges declared in their package manifests. A runtime outside those ranges may work but is not part of release verification.
